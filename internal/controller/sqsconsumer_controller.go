...
// ingestionBucket is the bucket name for data ingestion
// TODO: This should be configured via Config CR when available
var ingestionBucket = "data-ingestion-bucket"
